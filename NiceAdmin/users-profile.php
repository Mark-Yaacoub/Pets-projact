...
if (isset($_POST['changImgPpp'])) {
  ...
  $phone = $_POST['phone'];
    ...
    $id2 = $_SESSION['adminId'];


    $update3 = "UPDATE `admin` SET `name`='$name',`phone`='$phone', `email`='$email' , `image`='$image1' WHERE id = $id2";
    $u1 = mysqli_query($conn, $update3);
    if ($u1) {
        echo '<script>alert("info uploda")</script>';
...
//   $id9 = $_SESSION['adminId'];
  
//   $updateinfo = "UPDATE `admin` SET `name`='$name',`phone`='$phone', `email`='$email',`password`='$password', WHERE id = $id9";
        ...
        <?php foreach ($s as $data) { ?>
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="../NiceAdmin/uploaded_img/<?php echo $data['image'] ?>" alt="" class="rounded-circle">
                  ...
                  <form method="POST" enctype="multipart/form-data">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="../pets/uploaded_img/<?php echo $data['image'] ?>" alt="Profile">
                        <div class="pt-2">
                        
                        <input name="changImgP" class="" accept="image/jpg, image/jpeg, image/png" type="file">
                    ...
                    <div class="text-center">
                      <button  name="changImgPpp" class="btn btn-primary">Save Changes</button>
                    </div>
